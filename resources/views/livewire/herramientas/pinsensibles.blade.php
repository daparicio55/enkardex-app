            ...
            <div class="col-sm-12 col-md-6">
                <div class="card text-center">
                    <div class="card-header bg-info">
                        <h5 class="h5 mb-0">
                            <i class="fas fa-child"></i> Perdidas Insensibles
                        </h5>
                        <p class="mb-0">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-sm-6">
                                ...
                                <label for="" class="mt-4">Número de Horas</label>
                                <input type="number" min="1" max="300" class="form-control" required wire:model="horas">
